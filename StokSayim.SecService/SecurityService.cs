...
namespace StokSayim.SecService
{
    public class SecurityService
    {
        static RegistryKey BaseFolderPath = Registry.CurrentUser;
        static string subFolderParth = "StokSayim";
        ...
        public static void Registry_Write()
        {
            ...
            var connString = "";
            var encryptedString = secHashSerice.EncryptString(key, connString);
        ...
        public static string Registry_Read()
        {
            ...
            return secHashSerice.DecryptString(key, a);
        }
        public static class secHashSerice
        {
